# Git Workflow for Vecia Website

**Clear Rules for Team Collaboration**

**Last Updated:** January 2025
**Team:** Alexandre + Tanguy
**Purpose:** Define who can do what with Git to avoid conflicts

---

## Quick Start for Tanguy
...
# Push to GitHub
git push origin tanguy/update-pricing-page
```
...
5. Merge when ready (or ask Alexandre to review)
...
| Tell Alexandre what you're working on | Don't both edit same files |
...
# Totally stuck? Ask Alexandre or:
...
**Types:** `feat` (new feature), `fix` (bug fix), `style` (CSS/design), `docs` (documentation), `refactor` (code cleanup)

---

## Communication

Quick Slack message before working:
> "Je travaille sur la page pricing cet après-midi"

This prevents both of us editing the same files.

---

# Advanced: Full Team Workflow
