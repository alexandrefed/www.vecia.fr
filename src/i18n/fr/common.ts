export const common = {
    ...
    'suite.title': 'Ce que l\'IA Fait Pour Vous',
    'suite.subtitle': 'Des résultats concrets, pas des promesses. Voici ce que nos clients obtiennent réellement.',

    // Tab 1: Find More Customers - HERO + GRID Layout
    'suite.tab1.label': 'Trouvez Plus de Clients',
    'suite.tab1.description': 'Vos campagnes tournent 24h/24. L\'IA cible les bons prospects, optimise vos publicités et génère des leads qualifiés pendant que vous dormez.',
    'suite.tab1.features.title': 'Comment ça marche',
    'suite.tab1.feature1': 'Ciblage automatique de vos audiences idéales',
    'suite.tab1.feature2': 'Optimisation des campagnes en continu',
    'suite.tab1.feature3': 'Tests A/B sans intervention manuelle',
    'suite.tab1.feature4': 'Rapports de performance en temps réel',
    // Hero metric (large, prominent)
    'suite.tab1.hero.title': 'Nouveaux Leads Générés',
    'suite.tab1.hero.value': '+47%',
    'suite.tab1.hero.status': 'Client e-commerce, 6 mois d\'automatisation',
    // Supporting cards (3 cards below hero)
    'suite.tab1.card1.title': 'Coût par Lead',
    'suite.tab1.card1.value': '-32%',
    'suite.tab1.card1.status': '↓ Optimisé par l\'IA',
    'suite.tab1.card2.title': 'Campagnes Actives',
    'suite.tab1.card2.value': '24/7',
    'suite.tab1.card2.status': 'Sans intervention',
    'suite.tab1.card3.title': 'ROI Moyen',
    'suite.tab1.card3.value': '342%',
    'suite.tab1.card3.status': '↑ Sur 90 jours',
    // Testimonial
    'suite.tab1.testimonial.quote': 'Je dépensais en publicité Meta Ads sans avoir une visibilité claire sur ce qui marchait. Après 2 mois avec Vecia, mes coûts par lead ont baissé de 30%. Je comprends enfin où va mon argent.',
    'suite.tab1.testimonial.author': 'Responsable Marketing, E-commerce',

    // Tab 2: Convert Faster - PIPELINE Layout (vertical funnel)
    'suite.tab2.label': 'Convertissez Plus Vite',
    'suite.tab2.description': 'Vos devis partent en 45 minutes au lieu de 20 heures. Vos prospects reçoivent un suivi personnalisé instantané. Votre pipeline avance sans vous.',
    'suite.tab2.features.title': 'Comment ça marche',
    'suite.tab2.feature1': 'Devis générés automatiquement en minutes',
    'suite.tab2.feature2': 'Suivi personnalisé de chaque prospect',
    'suite.tab2.feature3': 'Relances automatiques au bon moment',
    'suite.tab2.feature4': 'Qualification des leads en temps réel',
    // Pipeline stages
    'suite.tab2.stage1.title': 'Leads Entrants',
    'suite.tab2.stage1.value': '847',
    'suite.tab2.stage1.percent': '100',
    'suite.tab2.stage2.title': 'Prospects Qualifiés',
    'suite.tab2.stage2.value': '612',
    'suite.tab2.stage2.percent': '72',
    'suite.tab2.stage3.title': 'Devis Envoyés',
    'suite.tab2.stage3.value': '384',
    'suite.tab2.stage3.percent': '45',
    'suite.tab2.stage4.title': 'Clients Signés',
    'suite.tab2.stage4.value': '156',
    'suite.tab2.stage4.percent': '18',
    'suite.tab2.footer.label': 'Temps moyen de conversion',
    'suite.tab2.footer.value': '45 min',
    'suite.tab2.footer.status': 'vs. 20h avant automatisation',
    // Testimonial
    'suite.tab2.testimonial.quote': 'Ça faisait 2 ans que mes commerciaux passaient des journées entières sur les devis. Grâce à Alexandre, on a tout automatisé. Maintenant c\'est 45 minutes. Mes gars n\'en reviennent toujours pas.',
    'suite.tab2.testimonial.author': 'Directeur Commercial, Distribution B2B',

    // Tab 3: Free Up Time - CIRCULAR Layout (hub & spoke)
    'suite.tab3.label': 'Libérez du Temps',
    'suite.tab3.description': 'Vos tâches répétitives disparaissent. Reporting, saisie de données, emails de routine - l\'IA s\'en occupe. Vous vous concentrez sur ce qui compte.',
    'suite.tab3.features.title': 'Comment ça marche',
    'suite.tab3.feature1': 'Rapports générés automatiquement',
    'suite.tab3.feature2': 'Synchronisation des données entre outils',
    'suite.tab3.feature3': 'Emails de routine envoyés à votre place',
    'suite.tab3.feature4': 'Alertes intelligentes (pas de bruit)',
    // Central hub metric
    'suite.tab3.hub.title': 'Heures Libérées par An',
    'suite.tab3.hub.value': '780h',
    'suite.tab3.hub.status': 'Soit 15h par semaine récupérées',
    ...
    'suite.tab3.card2.title': 'Saisie Données',
    'suite.tab3.card2.value': '195h',
    'suite.tab3.card2.percent': '25',
    'suite.tab3.card3.title': 'Emails Routine',
    'suite.tab3.card3.value': '156h',
    'suite.tab3.card3.percent': '20',
    'suite.tab3.card4.title': 'Relances',
    'suite.tab3.card4.value': '117h',
    'suite.tab3.card4.percent': '15',
    // Testimonial
    'suite.tab3.testimonial.quote': 'Je passais mes lundis à compiler des rapports Excel. Maintenant l\'IA le fait pendant le weekend et je peux me concentrer sur mes clients.',
    'suite.tab3.testimonial.author': 'Gérant, Cabinet de conseil',

    // Tab 4: Keep Your Customers - SCOREBOARD Layout
    'suite.tab4.label': 'Gardez Vos Clients',
    'suite.tab4.description': 'Vos clients reçoivent des réponses instantanées. Les problèmes sont détectés avant qu\'ils ne se plaignent. Votre service client ne dort jamais.',
    'suite.tab4.features.title': 'Comment ça marche',
    'suite.tab4.feature1': 'Réponses instantanées aux questions fréquentes',
    'suite.tab4.feature2': 'Détection proactive des problèmes',
    'suite.tab4.feature3': 'Suivi personnalisé de chaque client',
    'suite.tab4.feature4': 'Notifications automatiques (livraisons, etc.)',
    // Main scoreboard metric
    'suite.tab4.main.title': 'Taux de Rétention',
    'suite.tab4.main.value': '94%',
    'suite.tab4.main.target': '95%',
    'suite.tab4.main.status': '↑ +12 points vs. avant automatisation',
    // Supporting scorecards (2 cards)
    'suite.tab4.card1.title': 'Satisfaction Client',
    'suite.tab4.card1.value': '4.2/5',
    'suite.tab4.card1.target': '4.0',
    'suite.tab4.card1.status': '✓ Objectif dépassé',
    'suite.tab4.card2.title': 'Temps de Réponse',
    'suite.tab4.card2.value': '2h',
    'suite.tab4.card2.target': '4h',
    'suite.tab4.card2.status': '↓ vs. 24h avant',
    // Testimonial
    'suite.tab4.testimonial.quote': 'On perdait des clients parce qu\'on mettait 24h à répondre. Depuis l\'automatisation, ils reçoivent une réponse en 2h. Notre note est passée de 3.1 à 4.2. Et nous avons moins de réclamations.',
    'suite.tab4.testimonial.author': 'Responsable Service Client, Logistique',
