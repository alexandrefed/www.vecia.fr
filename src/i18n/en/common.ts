export const common = {
  ...
  // AI Suite Section - Outcome-Focused (Funnel Strategy)
  'suite.title': 'What AI Does For You',
  'suite.subtitle': 'Real results, not promises. Here\'s what our clients actually get.',

  // Tab 1: Find More Customers - HERO + GRID Layout
  'suite.tab1.label': 'Find More Customers',
  'suite.tab1.description': 'Your campaigns run 24/7. AI targets the right prospects, optimizes your ads, and generates qualified leads while you sleep.',
  'suite.tab1.features.title': 'How it works',
  'suite.tab1.feature1': 'Automatic targeting of your ideal audiences',
  'suite.tab1.feature2': 'Continuous campaign optimization',
  'suite.tab1.feature3': 'A/B testing without manual intervention',
  'suite.tab1.feature4': 'Real-time performance reports',
  // Hero metric (large, prominent)
  'suite.tab1.hero.title': 'New Leads Generated',
  'suite.tab1.hero.value': '+47%',
  'suite.tab1.hero.status': 'E-commerce client, 6 months of automation',
  // Supporting cards (3 cards below hero)
  'suite.tab1.card1.title': 'Cost per Lead',
  'suite.tab1.card1.value': '-32%',
  'suite.tab1.card1.status': '↓ AI-optimized',
  'suite.tab1.card2.title': 'Active Campaigns',
  'suite.tab1.card2.value': '24/7',
  'suite.tab1.card2.status': 'Zero manual work',
  'suite.tab1.card3.title': 'Average ROI',
  'suite.tab1.card3.value': '342%',
  'suite.tab1.card3.status': '↑ Last 90 days',
  // Testimonial
  'suite.tab1.testimonial.quote': 'I was spending on Meta Ads without any clear visibility on what was working. After 2 months with Vecia, my cost per lead dropped 30%. I finally understand where my money goes.',
  'suite.tab1.testimonial.author': 'Marketing Manager, E-commerce',

  // Tab 2: Convert Faster - PIPELINE Layout (vertical funnel)
  'suite.tab2.label': 'Convert Faster',
  'suite.tab2.description': 'Your quotes go out in 45 minutes instead of 20 hours. Prospects get instant personalized follow-ups. Your pipeline moves without you.',
  'suite.tab2.features.title': 'How it works',
  'suite.tab2.feature1': 'Quotes generated automatically in minutes',
  'suite.tab2.feature2': 'Personalized follow-up for every prospect',
  'suite.tab2.feature3': 'Automatic reminders at the right time',
  'suite.tab2.feature4': 'Real-time lead qualification',
  // Pipeline stages
  'suite.tab2.stage1.title': 'Incoming Leads',
  'suite.tab2.stage1.value': '847',
  'suite.tab2.stage1.percent': '100',
  'suite.tab2.stage2.title': 'Qualified Prospects',
  'suite.tab2.stage2.value': '612',
  'suite.tab2.stage2.percent': '72',
  'suite.tab2.stage3.title': 'Quotes Sent',
  'suite.tab2.stage3.value': '384',
  'suite.tab2.stage3.percent': '45',
  'suite.tab2.stage4.title': 'Deals Closed',
  'suite.tab2.stage4.value': '156',
  'suite.tab2.stage4.percent': '18',
  'suite.tab2.footer.label': 'Average conversion time',
  'suite.tab2.footer.value': '45 min',
  'suite.tab2.footer.status': 'vs. 20h before automation',
  // Testimonial
  'suite.tab2.testimonial.quote': 'For 2 years, my sales team spent entire days on quotes. Thanks to Alexandre, we automated everything. Now it takes 45 minutes. My guys still can\'t believe it.',
  'suite.tab2.testimonial.author': 'Sales Director, B2B Distribution',

  // Tab 3: Free Up Time - CIRCULAR Layout (hub & spoke)
  'suite.tab3.label': 'Free Up Time',
  'suite.tab3.description': 'Your repetitive tasks disappear. Reporting, data entry, routine emails - AI handles them. You focus on what matters.',
  'suite.tab3.features.title': 'How it works',
  'suite.tab3.feature1': 'Reports generated automatically',
  'suite.tab3.feature2': 'Data synced across all your tools',
  'suite.tab3.feature3': 'Routine emails sent on your behalf',
  'suite.tab3.feature4': 'Smart alerts (no noise)',
  // Central hub metric
  'suite.tab3.hub.title': 'Hours Freed Per Year',
  'suite.tab3.hub.value': '780h',
  'suite.tab3.hub.status': 'That\'s 15h per week back',
  // Mini cards (4 categories of time saved)
  'suite.tab3.card1.title': 'Reporting',
  'suite.tab3.card1.value': '312h',
  'suite.tab3.card1.percent': '40',
  'suite.tab3.card2.title': 'Data Entry',
  'suite.tab3.card2.value': '195h',
  'suite.tab3.card2.percent': '25',
  'suite.tab3.card3.title': 'Routine Emails',
  'suite.tab3.card3.value': '156h',
  'suite.tab3.card3.percent': '20',
  'suite.tab3.card4.title': 'Follow-ups',
  'suite.tab3.card4.value': '117h',
  'suite.tab3.card4.percent': '15',
  // Testimonial
  'suite.tab3.testimonial.quote': 'I used to spend my Mondays compiling Excel reports. Now the AI does it over the weekend and I can focus on my clients.',
  'suite.tab3.testimonial.author': 'Owner, Consulting Firm',

  // Tab 4: Keep Your Customers - SCOREBOARD Layout
  'suite.tab4.label': 'Keep Your Customers',
  'suite.tab4.description': 'Your customers get instant answers. Issues are detected before they complain. Your customer service never sleeps.',
  'suite.tab4.features.title': 'How it works',
  'suite.tab4.feature1': 'Instant answers to common questions',
  'suite.tab4.feature2': 'Proactive problem detection',
  'suite.tab4.feature3': 'Personalized follow-up for each customer',
  'suite.tab4.feature4': 'Automatic notifications (deliveries, etc.)',
  // Main scoreboard metric
  'suite.tab4.main.title': 'Retention Rate',
  'suite.tab4.main.value': '94%',
  'suite.tab4.main.target': '95%',
  'suite.tab4.main.status': '↑ +12 points vs. before automation',
  // Supporting scorecards (2 cards)
  'suite.tab4.card1.title': 'Customer Satisfaction',
  'suite.tab4.card1.value': '4.2/5',
  'suite.tab4.card1.target': '4.0',
  'suite.tab4.card1.status': '✓ Target exceeded',
  'suite.tab4.card2.title': 'Response Time',
  'suite.tab4.card2.value': '2h',
  'suite.tab4.card2.target': '4h',
  'suite.tab4.card2.status': '↓ vs. 24h before',
  // Testimonial
  'suite.tab4.testimonial.quote': 'We were losing customers because it took 24h to respond. Since automation, they get an answer in 2h. Our rating went from 3.1 to 4.2. And we have fewer complaints.',
  'suite.tab4.testimonial.author': 'Customer Service Manager, Logistics',
